    ...
    <main class="flex-shrink-0 main-container">
            ...
            <div class="container h-100">
                <div class="row h-100 justify-content-center text-center">
                    <div class="col-12 col-md-11 col-lg-10 align-self-center">
                        ...
                        <p class="my-4">For the humans by the human<br><span class="text-mute">Hand Crafted by <a href="../../../../../external.html?link=https://maxartkiller.com/" target="_blank">Maxartkiller</a> with </span><span class="text-danger">❤</span></p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-6 col-md-3 align-self-center">
                            <div class="text-center py-5">
                                <h1 class="f-80"><span class="countertext">150</span>+</h1>
        ...
        <div class="container-fluid section-150 bg-white position-relative overflow-hidden">
            ...
            <br>
            <div class="bottom-right bottom-50">
                <h2 class="f-200 opacity-5 text-truncate">Bootstrap 4</h2>
            </div>
            <div class="row mb-5">
                <div class="container">
                    <div class="row">
            ...
            <div class="row no-gutters">
                <div class="col-12 col-md-6 position-relative overflow-hidden section-150">
                    <div class="background">
                        ...
                        <div class="caption">
                            <a href="../../../../../external.html?link=https://unsplash.com/@mimithian?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge" target="_blank" rel="noopener noreferrer">
                                <span>
            ...
            <div class="row no-gutters">
                <div class="col-12 col-md-6 position-relative overflow-hidden">
                    <div class="background">
                        ...
                        <div class="caption">
                            <a href="../../../../../external.html?link=https://unsplash.com/@austindistel?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge" target="_blank" rel="noopener noreferrer"> <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                        <title>unsplash-logo</title>
                                        <path d="M10 9V0h12v9H10zm12 5h10v18H0V14h10v9h12v-9z"></path>
                                    </svg>
            ...
            <div class="row no-gutters">
                <div class="col-12 col-md-6 position-relative overflow-hidden section-150">
                    <div class="background">
                        ...
                        <div class="caption">
                            <a href="../../../../../external.html?link=https://unsplash.com/@danteov_seen?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge" target="_blank" rel="noopener noreferrer">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                        <title>unsplash-logo</title>
                                        <path d="M10 9V0h12v9H10zm12 5h10v18H0V14h10v9h12v-9z"></path>
