            ...
            <div class="container h-100">
                <div class="row h-100 h-sm-auto">
                    ...
                    <div class="col-11 col-sm-8 col-md-6 mx-auto align-self-center">
                        <h3 class="">🎈🎆Congratulation!🎉🎊</h3>
                        <p>Your submission was successful. Proceed to payment to finish the registration</p>
                        <h2 class="font-weight-bold mb-4"><a href="<?= base_url('pp?sku='.$id) ?>">Pass</a>  Payment</h2>
                    ...
                    <div class="col-11 col-sm-8 col-md-6 mx-auto align-self-end">
                        <div class="mb-4">
                            <a href="https://paystack.co" class=" btn btn-lg btn-default default-shadow btn-block">Proceed to payment <span class="ml-2 icon arrow_right"></span></a>
                        </div>
                        <div class="mb-4">
